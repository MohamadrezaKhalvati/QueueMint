    ...
    <div className="qm-screen animate-in fade-in slide-in-from-bottom-2 duration-200">
      <div className="qm-page-heading qm-page-heading-row flex flex-wrap items-end justify-between gap-4">
        ...
        <div className="qm-heading-actions flex flex-wrap items-center gap-2">
          <Button variant="outline" onClick={onCommands}><Command className="size-4" />{t.commandPalette}<kbd className="ms-1 rounded-[var(--qm-control-radius)] border bg-muted/30 px-1.5 py-0.5 text-[10px] text-muted-foreground">Ctrl/⌘ Shift K</kbd></Button>
      ...
      <section className="mb-5 rounded-[var(--qm-panel-radius)] border bg-card p-4 shadow-none sm:p-5">
        <div className="grid min-w-0 gap-4 xl:grid-cols-[minmax(0,1fr)_minmax(420px,.9fr)_auto] xl:items-end">
          <div className="flex min-w-0 items-center gap-3">
            <div className="grid size-11 shrink-0 place-items-center rounded-[var(--qm-panel-radius)] border border-primary/15 bg-primary/[0.07] text-primary"><SquareKanban className="size-5" /></div>
      ...
      <div className="mb-5 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
        {statCards.map(({ id, label, value, icon: Icon, detail }) => (
          <button key={id} type="button" onClick={() => onMode("manage")} className="rounded-[var(--qm-panel-radius)] border bg-card p-4 text-start transition-colors hover:border-primary/25 hover:bg-primary/[0.02]">
            <div className="flex items-start gap-3">
              <span className="grid size-9 shrink-0 place-items-center rounded-[var(--qm-control-radius)] bg-muted/55 text-muted-foreground"><Icon className="size-4" /></span>
      ...
      <div className="grid min-w-0 gap-5 xl:grid-cols-[minmax(0,1.35fr)_minmax(320px,.65fr)]">
        <section className="min-w-0 rounded-[var(--qm-panel-radius)] border bg-card p-4 sm:p-5">
          <div className="mb-4 flex items-start gap-3">
            <div className="grid size-9 shrink-0 place-items-center rounded-[var(--qm-control-radius)] bg-primary/10 text-primary"><Bookmark className="size-4" /></div>
          ...
          {!savedActions.length ? (
            <div className="grid min-h-40 place-items-center rounded-[var(--qm-panel-radius)] border border-dashed bg-muted/10 px-6 text-center text-sm text-muted-foreground">{t.noSavedActions}</div>
          ) : (
            <div className="space-y-2">
              {savedActions.slice(0, 6).map((action) => (
                <div key={action.id} className="flex items-center gap-3 rounded-[var(--qm-panel-radius)] border bg-background p-3">
                  <div className="grid size-9 shrink-0 place-items-center rounded-[var(--qm-control-radius)] bg-muted/50 text-muted-foreground"><WandSparkles className="size-4" /></div>
        ...
        <section className="min-w-0 overflow-hidden rounded-[var(--qm-panel-radius)] border bg-card p-4 sm:p-5">
          <div className="mb-4 flex min-w-0 items-start gap-3"><div className="grid size-9 shrink-0 place-items-center rounded-[var(--qm-control-radius)] bg-muted/55 text-muted-foreground"><Rocket className="size-4" /></div><div className="min-w-0"><h2 className="text-base font-semibold">{t.quickActions}</h2><p className="mt-1 text-xs text-muted-foreground">{t.commandPaletteHint}</p></div></div>
          <div className="grid min-w-0 gap-2">
            <Button variant="outline" className="qm-quick-action h-auto w-full min-w-0 justify-start gap-3 overflow-hidden whitespace-normal px-3 py-3" onClick={() => onMode("quick")}><span className="grid size-8 shrink-0 place-items-center rounded-[var(--qm-control-radius)] bg-primary/10 text-primary"><Bolt className="size-4" /></span><span className="qm-quick-action-copy min-w-0 flex-1 text-start"><span className="block truncate text-sm font-medium">{t.openQuickIssue}</span><span className="qm-quick-action-description mt-0.5 block whitespace-normal break-words text-[11px] font-normal leading-4 text-muted-foreground">{t.quickHint}</span></span></Button>
            <Button variant="outline" className="qm-quick-action h-auto w-full min-w-0 justify-start gap-3 overflow-hidden whitespace-normal px-3 py-3" onClick={() => onMode("bulk")}><span className="grid size-8 shrink-0 place-items-center rounded-[var(--qm-control-radius)] bg-muted/50 text-muted-foreground"><FileJson className="size-4" /></span><span className="qm-quick-action-copy min-w-0 flex-1 text-start"><span className="block truncate text-sm font-medium">{t.openImport}</span><span className="qm-quick-action-description mt-0.5 block whitespace-normal break-words text-[11px] font-normal leading-4 text-muted-foreground">{t.bulkHint}</span></span></Button>
            <Button variant="outline" className="qm-quick-action h-auto w-full min-w-0 justify-start gap-3 overflow-hidden whitespace-normal px-3 py-3" onClick={() => onMode("review")} disabled={!draftIssueCount}><span className="grid size-8 shrink-0 place-items-center rounded-[var(--qm-control-radius)] bg-muted/50 text-muted-foreground"><ListChecks className="size-4" /></span><span className="qm-quick-action-copy min-w-0 flex-1 text-start"><span className="block truncate text-sm font-medium">{t.openReview}</span><span className="qm-quick-action-description mt-0.5 block whitespace-normal break-words text-[11px] font-normal leading-4 text-muted-foreground">{t.reviewHint}</span></span></Button>
            <Button variant="outline" className="qm-quick-action h-auto w-full min-w-0 justify-start gap-3 overflow-hidden whitespace-normal px-3 py-3" onClick={() => onMode("worklog")}><span className="grid size-8 shrink-0 place-items-center rounded-[var(--qm-control-radius)] bg-primary/10 text-primary"><Clock3 className="size-4" /></span><span className="qm-quick-action-copy min-w-0 flex-1 text-start"><span className="block truncate text-sm font-medium">{locale === "fa" ? "دستیار ثبت زمان" : "Worklog Assistant"}</span><span className="qm-quick-action-description mt-0.5 block whitespace-normal break-words text-[11px] font-normal leading-4 text-muted-foreground">{locale === "fa" ? "زمان امروز را تکمیل کن یا روی انتخاب‌ها Worklog بزن." : "Complete today or log work on selected issues."}</span></span></Button>
            <Button variant="outline" className="qm-quick-action h-auto w-full min-w-0 justify-start gap-3 overflow-hidden whitespace-normal px-3 py-3" onClick={() => onMode("automation")}><span className="grid size-8 shrink-0 place-items-center rounded-[var(--qm-control-radius)] bg-primary/10 text-primary"><Sparkles className="size-4" /></span><span className="qm-quick-action-copy min-w-0 flex-1 text-start"><span className="block truncate text-sm font-medium">{locale === "fa" ? "اتوماسیون" : "Automations"}</span><span className="qm-quick-action-description mt-0.5 block whitespace-normal break-words text-[11px] font-normal leading-4 text-muted-foreground">{locale === "fa" ? "قوانین امن، پیشنهاد مسئول و تاریخچه فعالیت" : "Safe rules, smart assignment, and activity history."}</span></span></Button>
            <Button variant="outline" className="qm-quick-action h-auto w-full min-w-0 justify-start gap-3 overflow-hidden whitespace-normal px-3 py-3" onClick={() => onMode("manage")}><span className="grid size-8 shrink-0 place-items-center rounded-[var(--qm-control-radius)] bg-muted/50 text-muted-foreground"><SquareKanban className="size-4" /></span><span className="qm-quick-action-copy min-w-0 flex-1 text-start"><span className="block truncate text-sm font-medium">{t.openManager}</span><span className="qm-quick-action-description mt-0.5 block whitespace-normal break-words text-[11px] font-normal leading-4 text-muted-foreground">{t.manageHint}</span></span></Button>
          </div>
        </section>
      </div>
    </div>

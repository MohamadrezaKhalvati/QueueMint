  ...
  return (
    <div className="mb-5 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
      {cards.map(({ label, value, icon: Icon }) => (
        <div key={label} className="rounded-[var(--qm-panel-radius)] border bg-card p-4">
          <div className="flex items-start gap-3">
            <span className="grid size-9 place-items-center rounded-[var(--qm-control-radius)] bg-muted/55 text-muted-foreground"><Icon className="size-4" /></span>

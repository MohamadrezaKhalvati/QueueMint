            ...
            <div className="space-y-5">
              ...
              {!isEpic ? (
                <>
                  ...
                  {placement === "sprint" ? <Field><FieldLabel>{t.sprint}</FieldLabel><SprintSelect sprints={sprints} value={issue.sprint} defaultSprint={payload.defaults?.sprint} onValueChange={(sprint) => onUpdate({ sprint })} inheritedLabel={t.useDefault} backlogLabel={t.backlog} activeLabel={t.active} futureLabel={t.future} /></Field> : null}
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side={locale === "fa" ? "left" : "right"}>
        ...
        <SheetBody className="space-y-5">
          ...
          {placement === "sprint" ? <Field><FieldLabel>{t.defaultSprint}</FieldLabel><SprintSelect sprints={sprints} value={payload?.defaults?.sprint} onValueChange={(sprint) => onDefaults({ sprint })} allowInherited={false} noDefaultLabel={t.noDefault} backlogLabel={t.backlog} activeLabel={t.active} futureLabel={t.future} /></Field> : null}
